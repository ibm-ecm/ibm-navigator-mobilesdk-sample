...
**This Sample app will not compile without the IBM Navigator SDK binary framework. IBM Navigator Mobile 2.2.0 SDK is required.Please refer to the README pdf for detailed instructions on how to obtain it. It only compiles on Xcode 7.2 currently. ** 
